...
Environment 	DEV									QA									UAT									PROD		
				Role: Dev	Role: QA	Role: BA/ED	Role: Dev	Role: QA	Role: BA/ED	Role: Dev	Role: QA	Role: BA/ED	Role: Dev	Role: QA	Role: BA/ED
				full		read			-		read		full			-		read		read			-		read		read			-

*/

/* common groups 

'MEMIC1\SQL_Developer_Employees' -- Eric Wallace 
'MEMIC1\SQL_QA_Employees'  -- Caroline Leinhardt
'MEMIC1\SQL_Enterprise_Data_Employees' -- Matt Hollbrook
'MEMIC1\SQL_BA_Employees' -- Kristine Glace
'MEMIC1\SQL_OPS_Employees' -- Christine Gillis
*/
...
set @windows_user = --'MEMIC1\svc_prodinsurity'
'MEMIC1\SQL_Developer_Employees'
...
--where dbname like '%WCXP'

--where ObjectName = 'xp_dirtree'
